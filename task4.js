...
const infoTextE1 = document.getElementById("infor-text");
const meaningContainerE1 = document.getElementById("reasult-container");
...
async function fetchAPI(word){
    try {
        ...
        infoTextE1.innerText=`Searching for the result...`
...
else
{
        ...
        infoTextE1.innerText=`An error happned,try again later.`
    }
